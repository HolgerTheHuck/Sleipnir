...
using SleipnirModel = Sleipnir.Model;

namespace Sleipnir.Grpc;

/// <summary>
/// gRPC service that mirrors the Sleipnir CustomerHandler for benchmark comparison.
/// </summary>
public class CustomerGrpcService(CustomerService service) : CustomerGrpc.CustomerGrpcBase
{
    ...
    private static Customer MapCustomer(SleipnirModel.Customer c)
    {
