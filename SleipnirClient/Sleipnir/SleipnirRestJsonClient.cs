...
{
    public class SleipnirRestJsonClient : SleipnirClientBase, ISleipnirClient, IDisposable
    {
        ...
        public SleipnirRestJsonClient(string serverBaseUrl, HttpClient? httpClient = null, string apiPath = "api/sleipnir",
        ...
        public override async Task<SleipnirResponse?> Call(SleipnirRequest? request, CancellationToken ct = default)
        {
            ...
            // Bytes statt String lesen — SleipnirResponseParser macht EINEN Pass über die
            ...
            return SleipnirResponseParser.Parse(responseBytes);
        }
        ...
        public override async Task<IEnumerable<SleipnirResponse?>?> Call(SleipnirMultiRequest? request, CancellationToken ct = default)
        {
            ...
            var sleipnirResponses = SleipnirResponseParser.ParseArray(responseBytes);
            return sleipnirResponses ?? new List<SleipnirResponse?>();
        }
