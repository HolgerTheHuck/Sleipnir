...
namespace SleipnirCommon.Attribute
{
    ...
    ///   - bare (<c>[SleipnirDataContract]</c>)  → force-expand (z. B. für Fremdtypen,
    ///     die trotzdem dokumentiert werden sollen).
    ///   - <c>[SleipnirDataContract(Exclude = true)]</c> → force-opaque (nur Typname,
    ///     keine Expansion — z. B. für eigene Hilfstypen, die nicht im Contract stehen).
    /// </summary>
    [AttributeUsage(AttributeTargets.Class, Inherited = false)]
    public class SleipnirDataContractAttribute : System.Attribute
    {
        /// <summary>
