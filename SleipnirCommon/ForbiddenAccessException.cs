...
/// (<c>SleipnirInvoker</c> / <c>SleipnirAuthorizationInterceptor</c>) übersetzt sie in eine
/// <c>403 Forbidden</c>-Response (<see cref="Results.SleipnirErrorCategory.PermissionDenied"/>).
/// Im Unterschied zu <see cref="UnauthorizedAccessException"/>, die <c>401</c>
/// (<see cref="Results.SleipnirErrorCategory.Unauthenticated"/>) auslöst — "nicht eingeloggt".
/// </summary>
/// <remarks>
