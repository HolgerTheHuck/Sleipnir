...
{
    /// <summary>
    /// Authorize-Attribute für Sleipnir. Prüft, ob der Nutzer authentifiziert ist
    ...
    /// (<see cref="SleipnirHub.Extensions.SleipnirOptions.RequireAuthentication"/>=true)
    /// verlangen auch unbestückte Methoden einen authentifizierten User; mit
    /// <c>[SleipnirAnonymous]</c> lässt sich eine Methode explizit öffnen.
    /// </summary>
    [AttributeUsage(AttributeTargets.Method | AttributeTargets.Class)]
    public class SleipnirAuthoriseAttribute : Attribute
    {
        /// <summary>
        ...
        /// Wenn gesetzt, prüft der <c>SleipnirAuthorizationInterceptor</c> die Policy via
        ...
        /// <c>[SleipnirAuthorizeResource]</c>-Hook für resource-basierte Policies ist v1.x+.
        /// </summary>
        public string? Policy { get; set; }

        public SleipnirAuthoriseAttribute()
        {
        }

        public SleipnirAuthoriseAttribute(string role)
        {
            Role = role;
        }

        /// <summary>
        /// Die Methode wird im SleipnirService vor dem eigentlichen Methodenaufruf aufgerufen.
        ...
        /// im SleipnirAuthorizationInterceptor in SleipnirHub injiziert wird) — diese Methode
