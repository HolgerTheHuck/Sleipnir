...
const STORAGE_KEY = 'sleipnir-endpoint';
...
// Sleipnir-Server zeigen. Default ist dann leer (User muss Ziel eingeben). Eingebettet
...
const defaultApiPath = 'api/sleipnir';
 ...
 *
 * `isCustom` meldet, ob die Connection vom eingebetteten Default ("/"/"api/sleipnir")
