...
{
    private static SleipnirInvoker BuildInvoker(int maxParameterArrayLength, int maxResultElementCount)
    {
    ...
    {
        // Ein nackter `new SleipnirInvoker(...)` ohne Optionen-Verdrahtung muss
