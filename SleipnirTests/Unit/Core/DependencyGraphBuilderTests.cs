...
{
    private static SleipnirRequest CreateRequest(string id, string? stringData = "[]", Dictionary<string, string>? dependencyMapping = null)
    {
    ...
    {
        // Act
        var batches = DependencyGraphBuilder.SortByDependencyBatches(new List<SleipnirRequest>());
