...
/// <summary>
/// Unit tests for SleipnirDiscoveryService metadata generation.
/// </summary>
public class SleipnirDiscoveryServiceTests
{
    private readonly SleipnirInvoker _invoker;

    public SleipnirDiscoveryServiceTests()
    {
    ...
    public void GetDiscoveryInfo_ReturnsAllMethods()
    {
        ...
        // Assert
        controller.Methods.Should().HaveCount(20); // All methods decorated with [SleipnirMethod]
    ...
    public void GetDiscoveryInfo_Inference_KeepsFrameworkEnvelopeOpaque()
    {
        ...
        // SleipnirResponse liegt in SleipnirCommon.dll (fremde Assembly) → nicht expandieren (opaque).
        discovery.Types.Should().NotContainKey(typeof(SleipnirResponse).FullName!);
