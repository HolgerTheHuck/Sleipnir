...
// (the no-drift ingress gate), resolve it into the emitter input, and emit TrameGenerated.cs.
// This is the entry point shared by the Roslyn source generator (build path) and the
// server-side export/drift-check tool — both feed it a contract.trame.json and get C# text.
using System.Text.Json.Nodes;

namespace Trame.Codegen.Core;

public static class TrameCodegen
{
    /// <summary>
