...
builder.Services.AddTrame(options =>
{
...
// Trame-Transport-Middleware (WebSocket primär) + Controller-Registrierung in einem Aufruf.
...
// Trame-Endpunkte in einem Aufruf: REST + Developer-UI + SignalR-Hub (da UseSignalR = true).
app.MapTrame();
