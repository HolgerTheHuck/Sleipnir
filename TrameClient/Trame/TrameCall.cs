...
{
    public class TrameCall
    {
        private readonly string _controller;
        private readonly string _method;
        private string _name;
        private readonly List<TrameParameter> _parameters = new();
        private int _num = 0;
        ...
        private TrameCall(string controller, string method)
        {
            _controller = controller;
            _method = method;
        }

        public static TrameCall Init(string controller, string method)
        {
            return new TrameCall(controller, method);
        }

        public TrameCall Named(string name)
        {
            _name = name;
            return this;
        }
        ...
        /// </summary>
        public TrameCall Exposes(string jsonPath, string alias)
        {
        ...
        /// </summary>
        public TrameCall WithAlias(string dependencyPlaceholder)
        {
            ...
            _parameters.Add(new TrameParameter
            {
                Num = _num,
        ...
        /// </summary>
        public TrameCall Param(string parameterName, object? value)
        {
            _parameters.Add(new TrameParameter
            {
                Num = _num,
        ...
        /// </summary>
        public TrameCall With(params object?[] args)
        {
