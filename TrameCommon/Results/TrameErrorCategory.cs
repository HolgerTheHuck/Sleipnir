...
/// <summary>
/// Semantische Fehler-Kategorie — *zusätzlich* zum numerischen <see cref="TrameError.Code"/>,
...
/// (<c>TrameError.Category</c>, Key 4); bestehende Clients ignorieren es (STABILITY.md §3.2).
/// Anlehnung an gRPC-Status-Codes zur Senkung polyglotter Adoption-Reibung.
/// </remarks>
[JsonConverter(typeof(JsonStringEnumConverter))]
public enum TrameErrorCategory
{
    /// <summary>
