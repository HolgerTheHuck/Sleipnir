...
/// <summary>
/// Stabile, transport-uniforme Fehler-Code-Konstanten für Trame. Ersetzen die Magic
/// Numbers, die früher verstreut in <see cref="TrameResults"/> und den privaten
/// Fabriken des <c>TrameInvoker</c> standen. Die numerischen Werte sind HTTP-Status-
...
/// (semantische Kategorien, <see cref="TrameErrorCategory"/>) layert *zusätzlich*
/// auf, ohne die numerischen Codes umzubenennen.
/// </summary>
/// <remarks>
/// Phase 1 — siehe <c>docs/design/phase-1-interceptor-pipeline.md</c> und
/// <c>ERROR_CATALOG.md</c>. Die Codes sind die <c>TrameResponse.code</c> /
/// <c>TrameError.code</c> Werte auf dem Wire.
/// </remarks>
public static class TrameErrorCodes
{
    // ─── 2xx Success ────────────────────────────────────────────────────────
