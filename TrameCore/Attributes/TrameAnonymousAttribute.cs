...
{
    /// <summary>
    /// Opt-out von <see cref="TrameHub.Extensions.TrameOptions.RequireAuthentication"/>.
    /// Eine mit <c>[TrameAnonymous]</c> markierte Methode bleibt auch dann
    ...
    public class TrameAnonymousAttribute : Attribute
    {
    }
}