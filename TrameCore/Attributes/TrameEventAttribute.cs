namespace TrameCore.Attributes
{
    ...
    /// Analog zu <see cref="TrameMethodAttribute"/>, aber die Methode gibt ein
    ...
    /// <b>Backpressure:</b> bounded Buffer + drop-oldest + <c>trame.event.dropped</c>-Metrik.
    /// </para>
    /// </remarks>
    [System.AttributeUsage(System.AttributeTargets.Method)]
    public class TrameEventAttribute : System.Attribute
    {
        private readonly string _name;

        public TrameEventAttribute(string name)
        {
            _name = name;
        }

        /// <summary>Der Event-Name auf dem Wire (analog zu <see cref="TrameMethodAttribute.Name"/>).</summary>
