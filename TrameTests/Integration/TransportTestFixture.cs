...
/// <summary>
/// Echter, in-Prozess lauschender Kestrel-Host mit allen Trame-Transports
...
public class TransportTestFixture : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        app.UseTrame();
        app.MapTrameEndpoints("/api/trame");
        app.UseWebSockets();
        app.UseTrameWebSocket("/tramews");
        app.MapHub<global::TrameHub.Hub.TrameHub>("/tramehub");
    ...
    public TrameRestJsonClient CreateRestClient() => new(BaseUrl);
    public TrameWebSocketClient CreateWsClient() => new(BaseUrl);
    public TrameSignalrClient CreateSignalrClient(string? bearer = null, bool useMessagePack = true)
