...
/// Verhaltenseigenschaften end-to-end über den TrameInvoker:
///
...
public class ParallelAuthPropagationTests
{
    ...
    /// <summary>Baut einen TrameRequest mit Id, benannten JSON-Parametern und optionalem
    ...
    ///  [TrameAuthorise] / [TrameAuthorise(Role="Admin")] passieren.</summary>
