// Auto-generated root Sleipnir client (capability: signalr). Compose with the sleipnir-client runtime.
...
export class SleipnirClient {
  ...
  constructor(baseUrl: string, options: SleipnirClientOptions = {}) {
    this._router = new SleipnirTransportRouter({ baseUrl, capability: "signalr", ...options });
