...
// fixture, using the same trame-codegen core the CLI and DevUI use. This makes the
...
//
// The fixture lives outside trame-codegen's `files` set, so it is resolved by
// filesystem path (not via the package).
import { mkdirSync, writeFileSync } from "node:fs";
import { dirname, join, resolve } from "node:path";
import { fileURLToPath } from "node:url";
import { emitTsClient, buildEmitterInput, NamingResolver, loadDiscovery } from "trame-codegen/node";
